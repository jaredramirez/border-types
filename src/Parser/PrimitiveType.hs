...
instance JsonTypes.FromJSON Types.PrimitiveType where
  parseJSON =
    Json.toAesonParser displayParseError (Json.withValue parseJsonValue)
  ...
  case value of
    ...
    (JsonTypes.Array v) ->
      ...
      in case list of
           ...
           tupleValues ->
             traverse parseJsonValue tupleValues >>= (Right . Types.Tuple)
    (JsonTypes.Object o) ->
...
displayParseError err =
  case err of
    ...
    InvalidType invalidType ->
      "I was expecting a string or object type, but got " <>
