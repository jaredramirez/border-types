...
/* package border-types-0.1.0.0 */
#ifndef VERSION_border_types
#define VERSION_border_types "0.1.0.0"
#endif /* VERSION_border_types */
#ifndef MIN_VERSION_border_types
#define MIN_VERSION_border_types(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_border_types */
...
#define CURRENT_COMPONENT_ID "border-types-0.1.0.0-HRDlr953tTUI18FqF3oshb-border-types"
