...
if (<span class='ident' data-type="(Minimist.StrSet.elt, Minimist.StrSet.t) => bool">Minimist.has</span>(<span class='string' data-type="Minimist.StrSet.elt">&quot;help&quot;</span>, <span class='ident' data-type="Minimist.opts">opts</span>.<span class='field' data-type="Minimist.StrSet.t">presence</span>)) {
